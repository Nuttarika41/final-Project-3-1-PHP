        ...
        <nav class="navbar navbar-expand-lg table-Default navbar-dark ">
            ...
            <div class="container"  >
                <li class="nav-item dropdown">
                    <button class="btn btn-light" class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        LOGIN
                    </button>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="CUS_login.php">Customer</a>
